...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	c, err := controller.New("servicemeshentry-controller", mgr, controller.Options{Reconciler: r})
	if err != nil {
		return err
	}
	...
	// Watch for changes to secondary resource Pods and requeue the owner ServiceMeshEntry
...
func (r *ReconcileServiceMeshEntry) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	reqLogger.Info("Reconciling ServiceMeshEntry")
...
func newPodForCR(cr *meshv1.ServiceMeshEntry) *corev1.Pod {
