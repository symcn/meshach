...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	// Watch for changes to secondary resource Pods and requeue the owner ServiceAccessor
...
func (r *ReconcileServiceAccessor) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	reqLogger.Info("Reconciling ServiceAccessor")
	...
	// Set ServiceAccessor instance as the owner and controller
...
func newPodForCR(cr *meshv1.ServiceAccessor) *corev1.Pod {
