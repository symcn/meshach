...
var log = logf.Log.WithName("controller_appmeshconfig")
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	c, err := controller.New("appmeshconfig-controller", mgr, controller.Options{Reconciler: r})
	if err != nil {
		return err
	}
	...
	// Watch for changes to secondary resource Pods and requeue the owner AppMeshConfig
...
// ReconcileAppMeshConfig reconciles a AppMeshConfig object
...
// Reconcile reads that state of the cluster for a AppMeshConfig object and makes changes based on the state read
...
func (r *ReconcileAppMeshConfig) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	reqLogger.Info("Reconciling AppMeshConfig")
...
func newPodForCR(cr *meshv1.AppMeshConfig) *corev1.Pod {
