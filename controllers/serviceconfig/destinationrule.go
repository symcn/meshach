...
func (r *Reconciler) buildDestinationRule(svc *meshv1alpha1.ServiceConfig, meshSubsets []*meshv1alpha1.Subset) *networkingv1beta1.DestinationRule {
	var subsets []*v1beta1.Subset
	for _, sub := range meshSubsets {
