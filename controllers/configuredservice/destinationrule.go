...
func (r *Reconciler) reconcileDestinationRule(ctx context.Context, cr *meshv1alpha1.ConfiguredService) error {
...
func (r *Reconciler) buildDestinationRule(svc *meshv1alpha1.ConfiguredService) *networkingv1beta1.DestinationRule {
...
func (r *Reconciler) getDestinationRuleMap(ctx context.Context, cr *meshv1alpha1.ConfiguredService) (map[string]*networkingv1beta1.DestinationRule, error) {
